...
| 5 | Адаптер личного кабинета на Playwright | ✅ 19 тестов на живом Chromium; карта ТСЖ «Вымпел» прошла боевую отправку |
| 6–7 | Десктопный хост: наблюдатель, обработчик очереди, watchdog, почта | ✅ 47 тестов |
| 2* | Подбор модели замерами по фикстурам | ✅ порог взят: 100 % целой части и серийников, 80 % точных; нужны ещё фикстуры |
...
| [presets/](presets) | готовые карты селекторов личных кабинетов |
...
presets/
  <кабинет>.json                 готовая карта селекторов личного кабинета
tools/
